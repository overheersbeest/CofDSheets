...
namespace CofD_Sheet
{
	public partial class Form1 : Form
	{
		...
		{
			{ SheetType.None, new List<SheetType>() { SheetType.Mortal, SheetType.Mage, SheetType.Vampire, SheetType.Werewolf, SheetType.Promethean, SheetType.Bound, SheetType.Lost, SheetType.Ephemeral_Entity, SheetType.Other } },
