		...
		public Sheet(SheetType type)
		{
			switch (type)
			{
				case SheetType.Mortal:
					...
					components.Add(new SkillsComponent("Social_Skills", new List<string> { "Animal Ken", "Empathy", "Expression", "Intimidation", "Persuasion", "Socialize", "Streetwise", "Subterfuge" }, ColumnId.Left));
				...
				case SheetType.Bound:
					...
					components.Add(new MeritsComponent("Merits", "merit", true, new List<string>(), 5, ColumnId.Middle));
					components.Add(new MeritsComponent("Remembrance Traits", "remembrance trait", true, new List<string>(), 0, ColumnId.Middle));
					components.Add(new MeritsComponent("Keys", "key", true, new List<string>(), 0, ColumnId.Middle));
					components.Add(new MeritsComponent("Manifestations", "manifestation", true, new List<string>(), 5, ColumnId.Middle));
					components.Add(new AdvantagesComponent("Advantages", new List<string> { "Root", "Bloom", "Size", "Speed", "Defense", "Armor", "Initiative Mod" }, ColumnId.Middle));
					components.Add(new ExperienceComponent("Experience", "Beats", ColumnId.Middle));

					components.Add(new HealthComponent("Health", ColumnId.Right));
					components.Add(new ResourceComponent("Willpower", ColumnId.Right));
					components.Add(new ResourceComponent("Plasm", ColumnId.Right));
					components.Add(new StatComponent("Synergy", ColumnId.Right));
					components.Add(new MeritsComponent("Conditions", "condition", true, new List<string>(), 0, ColumnId.Right));
					components.Add(new AspirationsComponent("Aspirations", 3, ColumnId.Right));
					components.Add(new MeritsComponent("Equipment", "equipment", true, new List<string>(), 0, ColumnId.Right));
					break;
